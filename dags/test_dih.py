        ...
        with TaskGroup(group_id="{}_S2F".format(stagegrp)) as run_stage0:
            ...
            with TaskGroup(group_id="{}_S2HS".format(stagegrp)) as run_stage1:
                ...
                for landtab in snowsqljobs[stagegrp]["table"]:
                    ...
                    taskid = 'TA_' + taskname
                    commands = "{};echo {} | kinit {}@{} && ssh -o StrictHostKeyChecking=no -o GSSAPIAuthentication=yes -o GSSAPIDelegateCredentials=yes {}@{} '{}'".format(password,kinitprincipal, kinitdomain, kinitprincipal, edgenodehost, "{} {} {}".format(expo,commands, tabname, dbname))
